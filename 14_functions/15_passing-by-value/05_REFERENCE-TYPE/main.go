...
servers a purpose different from new(T). It creates slices, maps, and channels only,
and returns an initialzed (not zeroed) value of type T (not *T). The reason for
...
the value for use.
*/
// http://golang.org/doc/effective_go.html#allocation-make
